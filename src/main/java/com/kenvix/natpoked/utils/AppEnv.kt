...
object AppEnv : ManagedEnvFile(AppConstants.workingPath.resolve(".env")) {
    ...
    val PortGuessExtendedLinearMaxRange: Int by envOf(30)
    ...
    val EchoServerPortRange: String by envOf("15704-15708")
    ...
    val PeerCommunicationModel: String by envOf("AIO")
    ...
    val PeerToBrokenTimeout by envOf(10_000)
...
//    }
    ...
    val EchoPortList: IntArray = parseIntRangeToArray(EchoServerPortRange)
}
