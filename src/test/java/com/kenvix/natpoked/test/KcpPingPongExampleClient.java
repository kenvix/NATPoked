//--------------------------------------------------
// Class KcpPingPongExampleClient
//--------------------------------------------------
...
//        s.bind(address);
        ...
        kcpClient.connect(new InetSocketAddress("0.0.0.0", 10000), new InetSocketAddress("127.0.0.1", 10001), channelConfig, kcpClientRttExample);
    }
    int i =0;
